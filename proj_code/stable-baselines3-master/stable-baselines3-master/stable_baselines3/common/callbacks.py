...
class ConvertCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        #TODO: I have just commented this out to lazily see if things will work without callbacks - really we do need this to work so see waht goes wrong when i uncomment this and fix it
        return True
