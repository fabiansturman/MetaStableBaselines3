...
#######################################################
model_save_path = "saved_models/27May_MAML_A2C_KDcont3_fakeCVaR2" #simulatenously testing my new maml syntax out and doing PPO (if somethings up, then try A2C with my new maml syntax to see if its my PPO that is wrong or the MAML syntax (too?))
...
env = gym.make("KhazadDum-v1", continuous=True, max_speed=0.5, action_noise=2,max_episode_steps=64) # can access wrapped env with "env.unwrapped" (e.g. to reset task)
