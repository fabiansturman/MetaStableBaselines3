    ...
    **References**
    ...
    def __init__(self, task=None, gymnasium_env_name = 'HalfCheetah-v5'):
       ...
       # print(f"observation space: {self.observation_space}")
        ...
        gym.utils.EzPickle.__init__(self) #<- TODO: do I need this?
    ...
    def set_task(self, task):
        ...
        self.env._forward_reward_weight = 1# task['direction'] #sets the reward function s.t. it rewards movement in the desired direction
    ...
    def _get_obs(self):
        print(self.env)
        return self.env._get_obs() #an oracle would have the task condatenated to the observations here
...
class NormalizeActionWrapper(gymnasium.Wrapper):
    """
